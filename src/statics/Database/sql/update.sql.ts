...
export const FIELD_UPDATE = (field: Field) =>
  `UPDATE fields SET name = '${field.name}', type = '${field.type}', defaultValue = '${field.defaultValue}', additionalOptions = '${field.additionalOptions}', defID = '${field.defID}' WHERE id = '${field.id}'`;
